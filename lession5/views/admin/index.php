...
<form action="admin" method="post">
    Title Article:<br>
    <input type="text" name="title" style="width: 350px;height: 25px" value="<?php echo $this->article['title']?>"><br>
    Content Article:<br>
    <textarea name="content" rows="10" cols="60" ><?php echo $this->article['content']?></textarea><br><br>
    Status:<br>
